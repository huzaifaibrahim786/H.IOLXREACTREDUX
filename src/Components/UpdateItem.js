...
class UpdateItem extends React.Component{
   ...
   constructor(){
    ...
    componentDidMount(){
        ...
        const userRef = firebase.database().ref('/').child("products/"+this.props.match.params.itemkey);
        ...
        const imgRef = firebase.database().ref('/').child("products/"+this.props.match.params.itemkey+"/images/");
    ...
    success=()=>{
        ...
        firebase.database().ref('products/'+title+this.state.sellername).set({
        ...
        firebase.database().ref('products/'+this.state.title+this.state.sellername+'/images').set(this.state.images)
    ...
    render(){
        ...
        if(name === null || email === null || photoURL === null || uid === null ||name === 'null' || email === 'null' || photoURL === 'null' || uid === 'null'|| itemkey === '' || itemkey === null || itemkey === 'null'){
                            ...
                            <div>
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        <img src={this.state.photoURL} alt="logo"/>
                                    </div>
                                    <div className="col-md-8">
                                        <p>Name<sup>*</sup></p>
                                            <input type="text" className="form-control" onChange={this.handleChange} name="name" id="name" value={this.state.sellername} readOnly maxLength="150" minLength="25" style={{border:"2px solid black",marginTop:"-15px",height:"40px"}}/>
                                    </div>
                                ...
                                <div className="input-group mb-3 border-black" style={{marginTop:"-15px",border:"2px solid black"}}>
                                    ...
                                    <input type="text" className="form-control" onChange={this.handleChange} name="no" value={this.state.phone} aria-label="Dollar amount (with dot and two decimal places)"/>
                                </div>
                                <br/>
                                <div className="row">
                    ...
                    <div className="col-md-7">
                        <button className="btn btn-secondary" onClick={this.success} style={{backgroundColor:"#002F34",color:"white"}} 
                            disabled={!this.state.title || !this.state.description || !this.state.condition
                                        ...
                                        || !this.state.nh || !this.state.phone}
                                        >POST NOW</button>
                        <br/>
                    </div>
